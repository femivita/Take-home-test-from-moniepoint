...
import 'package:take_home_test/views/widgets/rating_item.dart';
import 'package:take_home_test/views/widgets/review_chip.dart';
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) => Padding(
              ...
              child: product.otherImgs[index] != product.otherImgs.last
                  ? Container(
                      height: 20,
                      width: 80,
